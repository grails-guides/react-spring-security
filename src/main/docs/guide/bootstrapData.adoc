...
Edit `server/grails-app/init/react/spring/security/BootStrap.groovy`:

[source,groovy]
.server/grails-app/init/react/spring/security/BootStrap.groovy
----
include::{sourceDir}/server/grails-app/init/react/spring/security/BootStrap.groovy[indent=0,lines=5..25]
----
