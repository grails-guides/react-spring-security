...
Edit `server/grails-app/domain/react/spring/security/Driver.groovy`:

[source, groovy]
.server/grails-app/domain/react/spring/security/Driver.groovy
----
include::{sourceDir}/server/grails-app/domain/react/spring/security/Driver.groovy[]
----
...
[source, groovy]
.server/grails-app/domain/react/spring/security/Make.groovy
----
include::{sourceDir}/server/grails-app/domain/react/spring/security/Make.groovy[]
----

[source, groovy]
.server/grails-app/domain/react/spring/security/Model.groovy
----
include::{sourceDir}/server/grails-app/domain/react/spring/security/Model.groovy[]
----

[source, groovy]
.server/grails-app/domain/react/spring/security/Vehicle.groovy
----
include::{sourceDir}/server/grails-app/domain/react/spring/security/Vehicle.groovy[]
----